...
## Evidence
Krzysztof approved the design as proposed (see .jarl/decisions.md, 080-batch-landing-approved). Ready for implementation dispatch. Held out of dispatch until issue 108 lands — both touch land.mjs (108: checkRevertTest; 080: run()'s gate-lock/merge flow), avoiding a self-inflicted merge conflict.
