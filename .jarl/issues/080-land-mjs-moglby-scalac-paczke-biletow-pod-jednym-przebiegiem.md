...
NOT YET DECIDED — flagging for review before implementation, since this changes a core landing mechanic: this design has not been put to Krzysztof yet. Recommend walking him through it (or an equivalent short design doc) before dispatching any implementation work, per this repo's own 'graph before code, lock the design in' standing preference.
